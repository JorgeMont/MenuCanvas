          ...
          <div className="form-container p-1">
            <form id="menu-form">
              <div className="form-categorias">
                <h3> Nombre menú <i><FaEdit/></i></h3>
                <p>Categorias</p>
                <input type="text" placeholder='Insertar Categoria'/><button> <i><AiOutlinePlus/></i> Crear Categoria</button>
                <ul>
                  <li>Desayunos</li>
                  <li>Comida</li>
                </ul>
              ...
              <div className="descripcion-platillo">
                ...
                <textarea rows="3" placeholder='Descripcion del platillo'></textarea>
              </div>

              <div className="form-btns d-flex">
                <button id="foto-platillo">Foto del Platillo <i><AiOutlineUpload/></i> </button>
              ...
              <input type="checkbox"/><label >Deshabilitar Platillo</label>
              </div>
                ...
                <div className='card d-flex row'>
                  <div className="card-body">
                    <div className="d-flex platillo">
                      <img src="https://picsum.photos/200" alt="" className='card-img-left' />
                      <div className="card-title">Este es el Titulo del platillo</div>
                      <small>$666</small>
                    </div>
